                ...
                with sr.Microphone() as source2:
                       ...
                       r.adjust_for_ambient_noise(source2, duration=0.2)
                        ...
                        if MyText == "hai" or MyText == "hello":
                            ...
                            engine.runAndWait()
                              ...
                              engine = pyttsx3.init()
                               ...
                               webbrowser.open_new_tab(
                                   "https://wynk.in/music/detailsearch/wakhra?q=wakhra%20swag%20feat.%20badshah")
                                engine = pyttsx3.init()
                            ...
                            engine = pyttsx3.init()
                            engine.say(
                                    "I am JARVIS... version ..1 point O...I have been created by... J. V. S. D. Co-operation. Its Members are JASPREET...VISHAL....Sonu.....DHRUV.")
                            engine.runAndWait()
                            ...
                            engine = pyttsx3.init()
                            engine.say(
                                    "Artificial Intelligence is Technique that mimics Human Behaviour.It is widely used today in every field.")
                            engine.runAndWait()
                        elif MyText == "deep learning" or MyText == "what is deep learning":
                            webbrowser.open_new_tab(
                                    "https://www.forbes.com/sites/bernardmarr/2018/10/01/what-is-deep-learning-ai-a-simple-guide-with-8-practical-examples/?sh=2c6e82058d4b")
                            engine = pyttsx3.init()
                            engine.say(
                            ...
                            engine.runAndWait()
                              ...
                              webbrowser.open_new_tab(
                               ...
                               engine = pyttsx3.init()
                                engine.say(
                                        "Here's The Blackboard From Chandigarh University")
                                engine.runAndWait()
